       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $('.portfolio-popup').magnificPopup({
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "Government Engineering College Bikaner",  /* You can change your address from here */
            html: "<b>Address</b>: <br> Government Engineering College, Bikaner, Bikaner India",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
